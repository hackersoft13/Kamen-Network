...
var xmlData = XMLData("visio3_fichiers/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='Cette table contient les détails de la forme'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>Intitulé</TH><TH>Valeur</TH></THEAD>";
	...
	if (shapeNode != null)
	{
		...
		{
			strCPHTML = "Aucun détail n'est disponible.";
		}
	}
