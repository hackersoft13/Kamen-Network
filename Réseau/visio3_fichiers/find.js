...
var strShapeName	= "Nom de la forme";
var strShapeText	= "Texte de la forme";
var strProps		= "Données de forme";
var strResults		= "Résultats de la recherche de :";

var strShape	= "Nom de la forme :";
var strNoCustomPropertiesToDisplayText = "Cliquez avec la souris sur une forme du dessin tout en appuyant sur Ctrl pour en afficher les détails.";
...
function FindOnClick()
{
	...
	if (searchTokensArray.length > 0)
	{
		...
		var strResultsHTML = "Aucun résultat.";
		var lastPageID = null;
		var shapeID;
		...
		if(ArrayLength > 0)
		{
			...
			for ( count = 0; count < ArrayLength; count++)
			{
				...
				strResultsHTML += '<p class="results"><a href="javascript:populateSearchResultDetails(\'results_'+ lastPageID +'_'+ shapeID +'\', '+ lastPageID +','+ shapeID +'); TogglePlus(\'results_' + lastPageID + '_' + shapeID + '\',\'img_' + lastPageID + '_' + shapeID + '\', hideResults)"><img src="plus.gif" style="padding-left:13px" alt="Affiche/masque les détails de la forme" width="13" height="9" border="0" id="img_'+ lastPageID +'_'+ shapeID +'"></a>\n'
